"""
omitest Session Report Generator
...
def generate_report(session_report: Dict, output_path: Optional[str] = None) -> str:
    ...
    doc.add_paragraph(
        "This report was generated by omitest, an AI-assisted penetration testing "
...
def generate_markdown_report(session_report: Dict, output_path: Optional[str] = None) -> str:
    ...
    a(f"# omitest — Penetration Test Report")
    a("")
    ...
    a("---")
    a("")
    a("> **Legal disclaimer.** Generated by omitest. All activity herein was "
...
def generate_pdf_report(session_report: Dict, output_path: Optional[str] = None) -> str:
    ...
    class _PDF(FPDF):
        def header(self):
            ...
            self.set_xy(8, 3)
            self.cell(0, 8, "omitest  |  Penetration Test Report  — CONFIDENTIAL")
    ...
    pdf.cell(0, 12, "omitest", ln=True, align="C")
    ...
    _para(
        "This report was generated by omitest and is intended SOLELY for use by "
