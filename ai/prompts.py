...
SYSTEM_PROMPT_COMPACT = """You are omitest, an elite autonomous red team operator on Kali Linux.
...
STRATEGIST_PROMPT = """You are the STRATEGIST for omitest, an autonomous red team operator.
...
CRITIQUE_PROMPT = """You are the VERIFIER for omitest, a meticulous red team reviewer.
